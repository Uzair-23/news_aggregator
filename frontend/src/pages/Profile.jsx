          ...
          <div className="card-base p-8 space-y-6">
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-xs text-dark-500 mt-1 capitalize">Role: {user?.role}</p>
              </div>
            </div>
              ...
              <>
                ...
                <div className="border-t border-surface-border pt-6 space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-dark-400 text-sm">Full Name</p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-dark-400 text-sm">Preferences</p>
          ...
          <div className="card-base p-6 space-y-4">
            ...
            <div className="space-y-3">
              {[
                ...
                <label key={idx} className="flex items-center gap-3 p-3 hover:bg-surface-hover rounded-lg transition-colors cursor-pointer">
                  <input type="checkbox" defaultChecked className="w-4 h-4 rounded border border-surface-border" />
                  <div>
                    <p className="font-medium">{pref.label}</p>
                    <p className="text-dark-400 text-sm">{pref.desc}</p>
                  </div>
                </label>
              ))}
            </div>
